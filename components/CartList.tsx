...
const CartList = () => {
  ...
  return (
    <div className="relative flex min-h-[50vh] w-full flex-col items-start justify-center gap-4 md:justify-between">
      ...
      <Link href={"/checkout"} className="absolute bottom-0 w-full">
